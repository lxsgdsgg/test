...
import com.bashiju.www.mapper.ArticleMapper;
...
public class HouseServiceImpl implements IHouseService {
	...
	@SystemServiceLog(operationType="按区域查询租房房源列表")
	@Override
	public WebPage<HouseListResult> queryRentHouseListByArea(RentHouseParam param, int page, int limit) {
		// TODO Auto-generated method stub
		return null;
	}
	@SystemServiceLog(operationType="按地铁查询租房房源列表")
	@Override
	public WebPage<HouseListResult> queryRentHouseListByMetro(RentHouseParam param, int page, int limit) {
		// TODO Auto-generated method stub
		return null;
	}
	...
	public List<HouseMapPointResult> querySellMapHouseMetro(HouseMapParam param) {
		if (param==null||StringUtils.isEmpty(param.getCityCode()) ||StringUtils.isEmpty(param.getMetroName())) {
			return null;
		}
