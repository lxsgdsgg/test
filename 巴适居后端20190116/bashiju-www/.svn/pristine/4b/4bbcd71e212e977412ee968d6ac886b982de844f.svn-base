...
public interface HouseMapper {
	...
	/**
	 * 
	 * @Title: queryHouseByCoummunity   
	 * @Description: TODO(根据小区模糊查询房源)   
	 * @param: @param communityName
	 * @param: @param type
	 * @param: @return      
	 * @return: List<HouseListResult>      
	 * @throws
	 */
	public Page<HouseListResult> queryHouseByCoummunity(@Param("communityName")String communityName,@Param("type")int type);
	/**
	 * 
	...
	public List<HouseListResult> queryGoodHouse(@Param("cityCode")String cityCode,@Param("type")String type);
