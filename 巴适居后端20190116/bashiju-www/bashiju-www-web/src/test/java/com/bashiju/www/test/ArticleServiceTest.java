...
public class ArticleServiceTest extends BaseServiceTest {
	...
	public void test3() {
		String cityCode = "530100";
		String type = "1";
		Page<ArticleListResult> res = iArticleService.queryArticleList(cityCode,"我的",type,0,5);
		for(int i=0;i<res.size();i++) {
			String a = res.get(i).getTitle();
		}
		System.out.println(res.toString());
	...
	public void test3() {
		String cityCode = "530100";
		int typeId = 0;
		Page<ArticleListResult> res = iArticleService.queryZiXunListByType(cityCode,typeId,0,5);
