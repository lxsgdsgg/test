...
public class DemandFollowRecordController  extends BaseController{
	...
	@ResponseBody
	public Map<String,Object> queryDemandFollowRecordRecordData(String transactionType,String isValid,String followType,String followerId,String custIdAndFollowfollower,String maintainId,String beginTime,String endTime,int page,int limit){
		...
		paramMap.put("custIdAndFollowfollower", custIdAndFollowfollower);
		paramMap.put("maintainId", maintainId);
		paramMap.put("beginTime", beginTime);
		paramMap.put("endTime", endTime);
		Page<Map<String,Object>> pages=demandFollowRecordService.queryDemandFollowRecordData(paramMap,page, limit);
