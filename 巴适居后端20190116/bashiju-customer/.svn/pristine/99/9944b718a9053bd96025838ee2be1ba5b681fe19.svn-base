...
public interface CustomerMapper {
	...
	public List<Map<String,Object>> queryLookHouseId(Map<String,Object> param);
	...
	public LinkedList<Map<String,Object>> queryCustomerPhone(@Param("demandId") String demandId,@Param("examineTypeId") String examineTypeId);
	...
	public String queryCustomerCompany(String demandId);
	public Page<Map<String, Object>> queryCustomerHouse(@Param("demandId") String demandId,@Param("companyId") String companyId);
	public Page<Map<String, Object>> queryCustomerDemand(@Param("demandId") String demandId,@Param("transactionTypeId") String transactionTypeId,@Param("companyId") String companyId);
	...
	public int queryExamineInfo(@Param("demandId") String demandId,@Param("examineTypeId") String examineTypeId);
	/**
	 * 
		 * 查询本公司、本城市的客源等级规则
	 ...
	 */
	public List<Map<String,Object>> queryCustomerLevel(@Param("cityCode")String cityCode,@Param("companyId")String companyId,@Param("transactionType")String transactionType);
	 ...
	 * 
		 ...
		 * Page<Map<String,Object>>
	 */
	public Page<Map<String, Object>> queryContractCustomer(Map<String,Object> param);
	/**
	 * 
		 * 查询我的私客列表
		 ...
		 * Page<Map<String,Object>>
	 */
	public Page<Map<String, Object>> queryMyPrivateGuest(@Param("transactionTypeId")Integer transactionTypeId,@Param("userId")Integer userId);
}
