...
public class CustomerController extends BaseController{
	...
	@ResponseBody
	public BashijuResult deleteImg(String demandId, String path) {
		Boolean res = customerService.deleteImg(demandId,path);
		return BashijuResult.ok(res);		
	}
	/**
	 * 
	...
	public BashijuResult saveCustomerPhone(@RequestBody Map<String,Object> data) {
		data.put("companyId", UserThreadLocal.get().get("companyId"));
		data.put("companyName", UserThreadLocal.get().get("comName"));
 ...
 * 
	 ...
	 * Map<String,Object>
 */
	@RequestMapping(value="queryMyPrivateGuest")
	@ResponseBody
	public Map<String,Object> queryMyPrivateGuest(int transactionTypeId,int page,int limit) {
		Page<Map<String, Object>> pageInfo = customerService.queryMyPrivateGuest(transactionTypeId,page, limit);
		Map<String,Object> map = new HashMap<String,Object>();
		map.put("count", pageInfo.getTotal());
		map.put("data", pageInfo.getResult());
		map.put("code", 0);
