...
public interface DemandFollowRecordService {
	 ...
	 */
	Page<Map<String,Object>>  queryDemandFollowRecordData(Map<String, Object> paramMap,int page,int limit);
	/**
	 * 
	 ...
	 * @return: Page<Map<String,Object>>
	 */
	Page<Map<String,Object>>  queryDemandFollowRecordByDemandId(String demandId,int page,int limit);
}
