...
public class IMetroServiceTest {
	...
	public void test1() {
		...
		List<String> res = iMetroService.queryMetroLines(cityCode);
	...
	public void test2() {
		String cityCode = "530100";
		String metroName = "1号线";
		List<MetroStationResult> res = iMetroService.queryMetroStationsByLine(cityCode, metroName);
		System.out.println(res.toString());
		assertNotNull(res);
	}
}
