package com.bashiju.wutils.datasource;
...
public class DynamicDataSource extends AbstractRoutingDataSource{
    ...
    protected Object determineCurrentLookupKey() {
        ...
        if (!"slave".equals(DynamicDataSourceHolder.getDataSourceKey())) {
           /* Object key = DynamicDataSourceHolder.getDataSourceKey(); */
              System.out.println("-------------->走写库,key为: master");            
            return "master";
        }
        Object key = getSlaveKey();        
        System.out.println("-------------->走读库,key为: " + key);
