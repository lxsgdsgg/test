...
public class HomePageServiceApiImpl implements IHomePageServiceApi {
	...
	public List<ThemeResult> querySellHouseThemes(String cityCode) {
		List<ThemeResult> results=commService.queryThemes(cityCode, ImgManageEnum.ERMAINIMG);
		return results;
	}
	...
	@Override
	public String thirdPartyLogin(CustCustomerInsertBingdingParam param) {
		String result = custCustomerService.thirdPartyLogin(param);
		return result;
	}
    ...
    public List<ImgResult> getBannerImg(String cityCode) {
    	List<ImgResult> res = imgService.queryImg(cityCode, "0");
    	return res;
    }
    
	//新房推荐背景图接口
    public List<ImgResult> getNewHouseBgImg(String cityCode) {
    	List<ImgResult> res = imgService.queryImg(cityCode, "7");
    	return res;
    }
	
	//微店宝图片接口
    public List<ImgResult> getWeiDianBaoImg(String cityCode) {
    	List<ImgResult> res = imgService.queryImg(cityCode, "3");
    	return res;
    }
    
   //租房主题图
    public List<ImgResult> getRentThemeImg(String cityCode) {
    	List<ImgResult> res = imgService.queryImg(cityCode, "2");
    	return res;
    }
    
    //关注、微信小程序图
    public List<ImgResult> getProgramImg(String cityCode) {
    	List<ImgResult> res = imgService.queryImg(cityCode, "6");
    	return res;
    }
