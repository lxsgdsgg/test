...
public interface CustomerPersonalCentralMapper {
	 ...
	 */
	public CustCustomerEntity queryPersonalInfo(@Param("custId")String custId,@Param("numType")String numType);
	/**
	 * 查询客户个人详细信息 
	 ...
	 * CustCustomerEntity
	 */
	public CustCustomerEntity queryPersonalDetailInfo(@Param("custId")String custId,@Param("numType")String numType);
	/**
	 * 客户修改密码
	 ...
	 * Page<Agent>
	 */
	public Page<Agent> queryMyselfAgentList(@Param("custId")String custId,@Param("agentType")String agentType);
	/**
	 * 查询我的预约
	 ...
	 */
	public Page<CustomerOwnerAppointmentEntity> queryMyselfAppointmentList(@Param("custId")String custId);
	/**
	 * 统计我的预约数量
	...
	/**
	 * 条件查询楼盘维护人信息
	 * @Title: queryBuildingGuardianInfo   
	 * @Description: 条件查询楼盘维护人信息   
	 * @param maintainId
	 * @return: Map<String,Object>
	 */
	public Map<String,Object> queryBuildingGuardianInfo(@Param("maintainId")String maintainId);
	
	/****
	 * 条件查询经纪人信息	
	 * @Title: queryMaintainInfoByAgentId   
	 * @Description: 条件查询经纪人信息
	 * @param maintainId  经纪人编号
	 * @return: Map<String,Object>
	 */
	public Map<String,Object> queryMaintainInfoByAgentId(@Param("maintainId")String maintainId);
	 ...
	 * List<AdministrativeDivisionEntity>
	 */
	public List<AdministrativeDivisionEntity> queryAllAreaList(@Param("parentCode") String parentCode);
	/**
	 * 删除我的预约
	 ...
	 */
	public boolean deleteAppointment(@Param("id")String id);
} 
