...
public interface HouseMapper {
	 ...
	 * @param: @return      
	 * @return: HouseTotalResult      
	 * @throws
	 */
	public HouseTotalResult queryErHouseTotalByCityCode(@Param("cityCode")String cityCode);
	...
	public Page<HouseFeedbackResult> queryFeedback(@Param("houseId")Long houseId,@Param("sort")int sort);
	/**
	 * 
		 * 查询同价位同小区租房列表
