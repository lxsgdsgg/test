...
public interface CommunityMapper {
	 ...
	 */ 
	public List<HouseListResult> querySealHousingByCommunityId(@Param("communityId")String communityId, @Param("room") Integer room);
	 ...
	 * @return:  List<HouseListResult>   
	 */ 
	public List<HouseListResult> queryLeaseHousingByCommunityId(@Param("communityId")String communityId, @Param("room") Integer room);
	 ...
	 */ 
	public List<CommunityPriceTrend> queryCommunityPriceTrend(@Param("communityId")String communityId);
	 ...
	 * @return: List<Community>       
	 */ 
	public List<Community> queryFirstPageHotCommunitys(@Param("cityCode")String cityCode, @Param("size")int size);
	 ...
	 * @return: List<Community>      
	 */ 
	public List<Community> queryCommunityByFullText(@Param("cityCode")String cityCode, @Param("params")String params);
