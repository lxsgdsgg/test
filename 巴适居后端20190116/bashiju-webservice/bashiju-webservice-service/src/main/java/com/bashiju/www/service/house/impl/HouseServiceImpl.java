...
public class HouseServiceImpl implements IHouseService {
	...
	public HouseTotalResult queryHouseTotalByCityCode(String cityCode) {
		...
		if(StringUtils.isEmpty(totalStr)) {//redis为空
			total = houseMapper.queryErHouseTotalByCityCode(cityCode);
	...
	public List<GoodHouseListResult> querySellGoodHouse(String cityCode) {
		String key = WebGlobal.HOME_SELLGOOD_REDIS_PREFIX+"GH_"+cityCode;
	...
	public WebPage<HouseFeedbackResult> queryFeedback(long houseId,int sort, int page, int limit) {
		...
		if(StringUtils.isEmpty(feedbackStr)) {
			Page<HouseFeedbackResult> pageInfo=houseMapper.queryFeedback(houseId,sort);
