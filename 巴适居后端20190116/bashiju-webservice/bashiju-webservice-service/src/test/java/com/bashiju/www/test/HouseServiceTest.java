...
public class HouseServiceTest extends BaseServiceTest{
	...
	public void queryHouseInfoApi() {
		HouseInfoResult house= apiService.querySellHouseInfo(65);
	...
	public void queryShowedAgents() {
		List<AgentResult> list=service.queryShowedAgents(65);
	...
	public void querySellHouseListByArea() {
		...
		param.setSort(2);
		param.setAsc(1);
		List<String> buildYears=new ArrayList<>();
		buildYears.add("1");
		buildYears.add("2");
		buildYears.add("3");
		buildYears.add("4");
		buildYears.add("5");
		param.setBuildYearCodes(buildYears);
