...
public interface CustCustomerMapper {
     ...
     * @return: long
     */
    public int  saveCustCustomer(CustCustomerEntity custCustomerEntity);
...
//    
     ...
     */
    public Map<String,Object> queryIsBingding(@Param("custId")String custId,@Param("numType")String numType);
...
//    public Map<String,Object> qqLogin(@Param("qqNumber")String qqNumber);
    ...
    /**
     * 查詢第三方用户信息
     * @Title: queryCustomerThirdInfo   
     * @Description: 查詢第三方用户信息
     * @param id 第三方账号id
     * @return: Map<String,Object>
     */
    public Map<String,Object> queryCustomerThirdInfo(@Param("id")String id);
}