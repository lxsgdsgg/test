...
public class LogHouseConsumerMq {
	...
	private void insertReport(BusinessLogModel model) {
		...
		if (LogBusinessOperateTypeEnum.ADD_HOUSE_FOLLOW_RECORD.equals(operateTypeEnum)) {
			...
			if (LogBusinessSourceTypeEnum.RENT_HOUSE.getCode().equals(model.getSourceTypeId()+"")) {
				map.put("operatTypeId",Integer.parseInt(ReportAnalysisTypeEnum.RENTHOUSE_FOLLOWUP.getCode()));
				map.put("operatTypeName",ReportAnalysisTypeEnum.RENTHOUSE_FOLLOWUP.getDesc());
			}else {
				map.put("operatTypeId",Integer.parseInt(ReportAnalysisTypeEnum.SELLHOUSE_FOLLOWUP.getCode()));
				map.put("operatTypeName",ReportAnalysisTypeEnum.SELLHOUSE_FOLLOWUP.getDesc());
			}
		...
		if (LogBusinessOperateTypeEnum.ADD_HOUSE_REALEXPLORATION.equals(operateTypeEnum)) {
			...
			map.put("sourceTypeName",ReportBusinessTypeEnum.FOLLOWUP.getDesc());
			if (LogBusinessSourceTypeEnum.RENT_HOUSE.getCode().equals(model.getSourceTypeId()+"")) {
				map.put("operatTypeId",Integer.parseInt(ReportAnalysisTypeEnum.RENTHOUSE_REALEXPLORATION.getCode()));
				map.put("operatTypeName",ReportAnalysisTypeEnum.RENTHOUSE_REALEXPLORATION.getDesc());
			}else {
				map.put("operatTypeId",Integer.parseInt(ReportAnalysisTypeEnum.SELLHOUSE_REALEXPLORATION.getCode()));
				map.put("operatTypeName",ReportAnalysisTypeEnum.SELLHOUSE_REALEXPLORATION.getDesc());
			}
		}
