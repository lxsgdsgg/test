...
public class TencentCloudController {
	...
	public void saveTencentRecord(@RequestBody Map<String,Object> map,HttpServletResponse response) throws IOException {
	...
	public void saveTencentRecordList(@RequestBody Map<String,Object> map,HttpServletResponse response) throws IOException {
