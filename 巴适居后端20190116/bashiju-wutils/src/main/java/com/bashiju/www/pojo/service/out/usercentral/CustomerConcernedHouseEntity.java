 ...
 * @Title:  CustomerConernedHouseEntity.java   
 * @Package com.bashiju.www.pojo.service.out.usercentral      
 * @author: zuoyuntao     
 * @date:   2018年7月26日 下午2:22:05   
 * @version V1.0 
...
/**
 * 我关注的房子实体类
 * @ClassName:CustomerConernedHouseEntity
 * @Description:我关注的房子实体类
 * @author:zuoyuntao
 * @date:2018年7月26日 下午2:22:05
 * @Copyright: 2018 www.bashiju.com Inc. All rights reserved.
 ...
 */
@Data
public class CustomerConcernedHouseEntity implements Serializable {
	/**   
	 * @Fields serialVersionUID : 串行版本标识ID
	 */ 
	private static final long serialVersionUID = 7559184120111062713L;
	/**登陆用户ID**/
	private String custId;
	/**关注时间**/
	private String concernedTime;
	/**房屋类型1新房2二手房3租房4小区5公寓**/
	private String houseType;
	/**房源标题**/
	private String titles;
	/**房源交易类型ID**/
	private String transactionTypeId;
	/**房源交易类型：1 出售 2 出租 3 租售**/
