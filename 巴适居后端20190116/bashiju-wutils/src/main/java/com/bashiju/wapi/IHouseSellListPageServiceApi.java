 ...
 */
public interface IHouseSellListPageServiceApi {
	/**
	 * 
		 * 查询二手房源列表除区域、地铁外的搜索条件类
		 * @Description: 查询二手房源列表除区域、地铁外的搜索条件类
		 * @param cityCode 城市代码
		 * @return 
		 * List<QueryCondition>
	 */
	 ...
	 * 
		 * 根据小区名称模糊搜索二手房房源
		 * @Description: 根据小区名称模糊搜索二手房房源 
		 * @param communityName 小区名称
		 * @return 
		 * WebPage<HouseListResult>
	 */
	WebPage<HouseListResult> queryHouseSellListByCoummunity(String cityCode,String communityName,int page,int limit);
	/**
	 * 
		 * 根据城市查询区县
