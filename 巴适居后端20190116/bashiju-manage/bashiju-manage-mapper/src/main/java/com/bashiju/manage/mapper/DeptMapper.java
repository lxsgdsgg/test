...
public interface DeptMapper {
	 ...
	 * @return: Map<String,Object>
	 */
	public Map<String,Object> queryDeptCityCode(@Param("deptId")String deptId);
	
	/**
	 * 条件查询部门的责任盘
	 * @Title: queryResponsibilityDisk   
	 * @Description: 条件查询部门的责任盘
	 * @param deptId 部门编号
	 * @return: List<Map<String,Object>>
	 */
	public List<Map<String,Object>> queryResponsibilityDisk(@Param("deptId")String deptId);
}
