...
public interface FormMapper {
	...
	public Page<Map<String, Object>> queryRegionType(Map<String,Object> conditions);
	public Page<Map<String, Object>> querySelectType(Map<String,Object> conditions);
	...
	public Page<Map<String, Object>> queryDynamicFormList(@Param("formType") Integer formType);
	
	public List<Map<String, Object>> queryDynamicFormFieldList(@Param("formId") long formId,@Param("cityCode") String cityCode);
	...
	public Page<Map<String, Object>> queryCompanyDynamicFormList();
	
	public List<Map<String, Object>> queryCompanyDynamicFormFieldList(@Param("formId") long formId,@Param("companyId") String companyId);
	...
	public LinkedList<Map> queryRegionValue(@Param("widgetCode") String widgetCode,@Param("cityCode") String cityCode);
