...
public interface TransferProcessMapper {
	 ...
	 * @throws
	 */
	public Map<String,Object> queryTransferProcByName(@Param("procName") String procName);
	/**
	 * 根据过户名称查询过户方案数据信息
	 ...
	 * @throws
	 */
	public Map<String,Object> queryTransferProcById(@Param("procId") String procId);
	/**
	 * 获取所有数据信息
