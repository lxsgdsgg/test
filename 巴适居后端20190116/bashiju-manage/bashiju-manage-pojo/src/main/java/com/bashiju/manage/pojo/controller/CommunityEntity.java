package com.bashiju.manage.pojo.controller;
...
public class CommunityEntity {
	 ...
	 /**地上停车位出售价 **/
	 private Double  groundParkingSalePrice;
	 /**地下停车位出售价 **/
	 private Double  underGroundParkingSalePrice;
	 /** 物业费**/
	...
	public Double getGroundParkingSalePrice() {
		return groundParkingSalePrice;
	}
	public void setGroundParkingSalePrice(Double groundParkingSalePrice) {
		this.groundParkingSalePrice = groundParkingSalePrice;
	}
	public Double getUnderGroundParkingSalePrice() {
		return underGroundParkingSalePrice;
	}
	public void setUnderGroundParkingSalePrice(Double underGroundParkingSalePrice) {
