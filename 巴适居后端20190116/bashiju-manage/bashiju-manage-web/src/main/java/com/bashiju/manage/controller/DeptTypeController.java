...
public class DeptTypeController extends BaseController {
	...
	/**
	 * 从枚举中获取部门类型下拉数据信息
	 * @Title: queryDeptTypeFromEnum
	 * @author: zuoyuntao  
	 * @Description:从枚举中获取部门类型下拉数据信息
	 * @return      
	 * Object
	 */
	@RequestMapping(value="queryDeptTypeFromEnum")
	@ResponseBody
	public Object queryDeptTypeFromEnum() {
		return DeptTypeEnum.queryEnumMap;
	}
