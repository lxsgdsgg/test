...
public class CommonSelectController extends BaseController{
	 ...
	 * 
		 ...
		 * List<Map<String,Object>>
	 */
	@RequestMapping(value="queryOpenCityCountyRegionAllCommunity")
	@ResponseBody
	List<Map<String, Object>> queryOpenCityCountyRegionAllCommunity(){
		return commService.queryOpenCityCountyRegionAllCommunity();
	}
	/**
	 * 
		 * 查询开通城市、公司
	 ...
	 * 
		 * 根据权限查询部门、用户
		 * @Description: 根据权限查询部门、用户
		 * @return 
		 * List<Map<String,Object>>
	 */
	@RequestMapping(value="queryDepartmentUserList")
	@ResponseBody
	List<Map<String, Object>> queryDepartmentUserList(){
		return commService.queryDepartmentUserList();
	}
	...
	@ResponseBody
	public Object queryAreaAndRegion(String cityCode,String deptId) {
		return commService.queryAreaAndRegion(cityCode,deptId);
	}
	/**
	 * 根据片区ID查询小区信息
	...
	/**
	 * 返回线程中的用户信息
	 * @Title: returnUserInfoUserThread
	 * @author: zuoyuntao  
	 * @Description:返回线程中的用户信息
	 * @return      
	 * Object
	 */
	@RequestMapping(value="returnUserInfoUserThread")
	@ResponseBody
	public Object returnUserInfoUserThread() {
	 ...
	 * @Description: 根据城市编号查询区域
	 * @param cityCode 城市编号
	 * @return: Object
	 */
	@RequestMapping(value="queryAreaByCityCode")
	@ResponseBody
	public Object queryAreaByCityCode(String cityCode) {
		return commService.queryAreaByCityCode(cityCode);
	}
	 ...
	 * @return: Object
	 */
	@RequestMapping(value="queryRegionByAreaCode")
	@ResponseBody
	public Object queryRegionByAreaCode(String areaCode) {
		return commService.queryRegionByAreaCode(areaCode);
	}
}
