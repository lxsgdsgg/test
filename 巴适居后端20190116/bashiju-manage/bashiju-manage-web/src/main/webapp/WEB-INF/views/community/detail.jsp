			  ...
			  <div class="layui-tab-content">
			    <div id="detailInfo" class="layui-tab-item layui-show">
			     ...
			     <div class="layui-col-md2">
			     	  <div class="layui-input-inline">
					    <span class="layui-form-span">物业类型:</span>				    
					     <span data-name="houseUseName" class="lableBlock"></span>
					  </div>
					 <div class="layui-input-inline">
					    <span class="layui-form-span">建筑类型:</span>				    
					     <span data-name="houseTypeName" class="lableBlock"></span>
					  </div>
					  <div class="layui-input-inline">
			     ...
			     <div class="layui-col-md10">
					  ...
					  <div class="layui-input-inline">
					  	<span class="layui-form-span">开发商:</span>
					  	<span data-name="developers" class="lableBlock"></span>
					  </div>
 ...
 <div>
 	...
 	<div class="layui-input-inline">
 		<div class="layui-col-md6">
					    ...
					    <div class="layui-col-md5">		    
					     <select id="houseUseId"  xm-select="houseUseId" xm-select-type="2">					
						<c:forEach var="item" items="${houseUses}">
					 ...
					 <div class="layui-col-md6">
					    ...
					    <div class="layui-col-md5">		    
					     <select id="houseTypeId"   xm-select="houseTypeId" xm-select-type="2">
				          <option value=""></option>
				          <option value="1">低层住宅</option>
				          <option value="2">多层住宅</option>
				          <option value="3">中高层住宅</option>
				          <option value="4">高层住宅</option>
				          <option value="5">其他形式住宅</option>
				        </select>
				        </div>
					  </div>
					   <div class="layui-input-inline">
					 <div class="layui-col-md6">
					    <span class="layui-form-span">建筑结构:</span>
					    </div>		
					    <div class="layui-col-md5">		    
					     <select id="buildTypeId"   xm-select="buildTypeId" xm-select-type="2">
				          <option value=""></option>
				          <option value="1">钢结构</option>
				          <option value="2">钢、钢筋混凝土结构</option>
				          <option value="3">钢筋混凝土结构</option>
  ...
  <div class="layui-col-md5">
			     	  <div class="layui-input-inline">			     	  
					    <span class="layui-form-span">街道:</span>	
					    <input type="text" name="street" lay-verify="address" style="width:300px !important;" class="layui-input">			    					     
					  </div>
</div>
	<div class="layui-col-md6">
		<div class="layui-input-inline">
			<span class="layui-form-span">开发商:</span>
			<input type="text" name="developers" lay-verify="address" style="width:300px !important;" class="layui-input">
		</div>
	</div>			 
  </div>
  <div class="layui-row">
  	<div class="layui-col-md12">
		<div class="layui-input-inline">
			<span class="layui-form-span">物业地址:</span>
			<input type="text" name="propertyAddress" lay-verify="address" style="width:800px !important;" class="layui-input">
		</div>
	</div>
  </div>
  <div class="layui-row">
  	<div class="layui-input-inline">
			<span class="layui-form-span">小区简介:</span>				    
			<input type="textarea" name="communityProfile" lay-verify="textarea" style="width:800px !important;height:100px !important;" class="layui-textarea">
	</div>
  </div>
...
function showAdd(){
	...
	$('#updateCommunity').removeClass("layui-hide");
	 ...
	 form.on('submit(communityAdd)', function(data){
		 //条件多选的中文
		   var houseUseName=formSelects.value('houseUseId', 'nameStr');
		 //得到多选下拉的值   
		 var houseUseId=formSelects.value('houseUseId', 'val');
		 if(houseUseId)data.field.houseUseId=houseUseId;
		 if(houseUseName)data.field.houseUseName=houseUseName;
		 
		//条件多选的中文
		   var houseTypeName=formSelects.value('houseTypeId', 'nameStr');
		 //得到多选下拉的值   
		 var houseTypeId=formSelects.value('houseTypeId', 'val');
		 if(houseTypeId)data.field.houseTypeId=houseTypeId;
		 if(houseTypeName)data.field.houseTypeName=houseTypeName;
		 
		//条件多选的中文
		   var buildTypeName=formSelects.value('buildTypeId', 'nameStr');
		 //得到多选下拉的值   
		 var buildTypeId=formSelects.value('buildTypeId', 'val');
		 if(buildTypeId)data.field.buildTypeId=buildTypeId;
		 if(buildTypeName)data.field.buildTypeName=buildTypeName;
		  $.ajax({
	            type: "POST",//方法类型
	         	...
	         	if(result.success){
	         		if(result.data!=null&&result.data.length>0){
	         			for(var i=0;i<result.data.length;i++){
	         				...
	         				$("#imageUl").append('<li><image onClick="showMaxImage(this.src)" class="communityImage" src="'+item.url+'"><i onClick="delImage(\''+item.code+'\')" class="delImage">x</i></li>')
	         			}
	         		}else{
