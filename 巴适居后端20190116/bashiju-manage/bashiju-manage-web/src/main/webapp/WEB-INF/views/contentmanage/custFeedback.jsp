	...
	<body class="">
		<div>
			<div class="layui-form" style="padding: 10px;">
			    ...
			    <div class="layui-inline ">
			    	...
			    	<button type="button" class="layui-btn searchFeedback"  lay-filter="*" >查找</button>
			    </div>
			...
			<table id="feedbackList" lay-filter="feedbackList" ></table>
		</div>
	    ...
	    layui.use(['element','form','table','layer','laydate','upload'], function(){
			  ...
			  var cols = [
			 		 ...
			 		 {field:"addTime",title:"填写时间",width:'120'},
			  ...
			  table.render({
			    elem: '#feedbackList'
			    ,height: 500
			    ,url:"<%=request.getContextPath()%>/manage/getCustFeedback" //数据接口
			    ,page: true //开启分页
			    ,cols: [cols]
		  		,method:'post'
