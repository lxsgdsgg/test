	  ...
	  <tbody>
		...
		<div class="layui-form-item" style="margin-left: 250px">
		    <div class="layui-input-block">
		      <button class="layui-btn" lay-submit lay-filter="resCustReturnCycleForm">立即提交</button>
...
layui.use(['form','table'], function(){
	  ...
	  form.on('submit(resCustReturnCycleForm)',function(data){
		  var tb = $("table").get(0);
		  var rows = tb.rows;
		  var arr = [];
	...
	$.ajax({
		    	type:"post",
		    	url:"saveOrUpdateResCustReturnCycle",
		    	dataType:"json",
