...
public interface WageSchemaSettingMapper {
	/**
	 * 查询工资方案集合--参数为字符串条件
	 ...
	 */
	public List<Map<String,Object>> queryAllWageSchemaSetingInfoByCondition(
	 ...
	 * List<Map<String,Object>> JSON 格式为：
	 */
	public List<Map<String,Object>> queryAllWageSchemaSetingInfoByMap(
	 ...
	 * long
	 */
	public long countWageSchemaInfoByCondition(@Param("condition") String condition); 
}
