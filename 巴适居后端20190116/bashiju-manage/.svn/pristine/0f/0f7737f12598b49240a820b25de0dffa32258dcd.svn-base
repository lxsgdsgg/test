...
public class MetroServiceImpl extends CommonSqlServie implements MetroService{
	 ...
	 */
	@Override
	public boolean saveOrUpdateMetro(Map<String,Object> paramMap) {
	...
	/**   
	 * 条件查询地铁线路
	 * <p>Title: queryMetroByCityCode</p>   
	 * <p>Description: 条件查询地铁线路</p>   
	 * @param cityCode 城市编码
	 * @see com.bashiju.manage.service.MetroService#queryMetroByCityCode(java.lang.String)   
	 */
	
	@Override
	public List<Map<String, Object>> queryMetroByCityCode() {
		List<Map<String, Object>> map = metroMapper.queryMetroByCityCode(UserThreadLocal.get().get("cityCode").toString());
		return map;
	}
