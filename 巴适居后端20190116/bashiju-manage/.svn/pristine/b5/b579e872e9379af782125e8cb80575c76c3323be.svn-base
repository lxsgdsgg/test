...
public class NavigationBarServiceImpl extends CommonSqlServie implements NavigationBarService {
	 ...
	 */
	@Override
	@SystemServiceLog(operationType="查詢导航栏数据")
	public Page<Map<String, Object>> queryNavigationBarData(int page,int limit,Map<String,Object> paramMap) {
		PageHelper.startPage(page, limit);
//		dataAuthHelper.auth(MenuEnum.MENU_54.getCode(),UserThreadLocal.get().get("id").toString());
	...
	public List<Map<String, Object>> queryNavigationBarTrees(String cityOpenInfoId) {
		return navigationBarMapper.queryNavigationBarTrees(cityOpenInfoId);
	}
	/**
	 * 
