...
public interface CommMapper {
	 ...
	 * 
		 ...
		 * List<Map<String,Object>>
	 */
	List<Map<String, Object>> queryCompanyOpenCity(@Param("companyId")String userId,@Param("cityCodes")List<String> cityCodes);
	 ...
	 * 
		 ...
		 * List<Map<String,Object>>
	 */
	List<Map<String, Object>> queryCompanyOpenCityCounty(@Param("companyId")String userId,@Param("cityCodes")List<String> cityCodes);
	 ...
	 * 
		 ...
		 * List<Map<String,Object>>
	 */
	List<Map<String, Object>> queryCompanyOpenCityRegion(@Param("companyId")String userId,@Param("cityCodes")List<String> cityCodes);
	/**
	 * 
		 * 根据片区id查询小区(不包括楼盘)
	 ...
	 * 
		 ...
		 * List<Map<String,Object>>
	 */
	List<Map<String, Object>> queryCompanyDepartment(@Param("companyId")String companyId,@Param("cityCodes")List<String> cityCodes);
	/**
	 * 
		 * 经济公司查看部门、用户下拉数据
		 ...
		 * List<Map<String,Object>>
	 */
	List<Map<String, Object>> queryCompanyDepartmentUser(@Param("companyId")String companyId,@Param("cityCodes")List<String> cityCodes);
	/**
	 * 
		 * 平台管理员查看城市、公司
	 ...
	 * List<Map<String,Object>> 
	 */
	public List<Map<String,Object>> queryAreaAndRegionByDeptIdAndArea(@Param("cityCode")String cityCode,@Param("deptId")String deptId);
	/**
	 * 根据片区ID查询小区信息
	 ...
	 * 
		 * 查询部门下的用户列表
		 * @Description: 查询部门下的用户列表
		 * @param deptIds
		 * @return 
		 * List<Map<String,Object>>
	 */
	public List<Map<String,Object>> queryDepartmentUserList(@Param("deptIds")List<String> deptIds);
	 ...
	 */
	public List<Map<String,Object>> queryAreaByCityCode(@Param("cityCode")String cityCode);
	 ...
	 * @return: List<Map<String,Object>>
	 */
	public List<Map<String,Object>> queryRegionByAreaCode(@Param("areaCode")String areaCode);
