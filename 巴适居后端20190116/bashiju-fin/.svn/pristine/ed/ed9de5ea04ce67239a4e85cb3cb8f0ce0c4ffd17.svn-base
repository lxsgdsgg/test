...
public class EmployeeCommissionsInfoServiceImpl extends CommonSqlServie implements EmployeeCommissionsInfoService {
	...
	public List<Map<String, Object>> queryEmployeeCommissionsInfo(String companyId,Long userId,String deptId,String startMonth,String endMonth,int businessType) {
		...
		return employeeCommissionsInfoMapper.queryEmployeeCommissionsInfo(companyId,userId,deptId,startMonth,endMonth,businessType);
	}
	...
	public Page<Map<String, Object>> queryEmployeeCommissionsInfo(String companyId,Long userId,String deptId,String startMonth,String endMonth,int businessType,int pageNum,int pageSize) {
		...
		Page<Map<String,Object>> page = (Page<Map<String, Object>>) this.queryEmployeeCommissionsInfo(companyId,userId,deptId,startMonth,endMonth,businessType);
		return page;
	}
