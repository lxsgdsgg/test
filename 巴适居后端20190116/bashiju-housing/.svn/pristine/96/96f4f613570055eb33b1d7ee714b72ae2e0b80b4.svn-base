...
public interface ErHousingMapper {
	...
	public Map<String,Object> queryAchievementRate(@Param("companyId") String companyId,@Param("achievementType") String achievementType);
	 ...
	 * 
		 ...
		 * Map<String, Object>
	 */
	public Map<String, Object> queryHouseUses(@Param("houseId")Long houseId);
}
