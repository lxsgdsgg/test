...
import com.bashiju.housing.mapper.BuildingMapper;
...
public class BuildingServiceImpl implements IBuildingService {
	...
	public long batchAddBuilding(Map<String, Object> param) {
		...
		ExecutionResult.descFormat(sourceId, "批量添加座栋");	
		return result;
	}
	...
	public List<Map<String,Object>> getRegionList(){
		...
		ExecutionResult.descFormat(curRgCode, "查询区域小区");	
		return buildingMapper.getRegionList(curRgCode);
	}
}
