...
public class PropertyDynamicServiceImpl extends CommonSqlServie implements PropertyDynamicService {
	...
	public boolean saveOrUpdatePropertyDynamic(Map<String,Object> paramMap) {
...
//	}
	...
	@Override
	public boolean saveOrUpdatePresalePermitListInfo(Map<String,Object> paramMap) {
		if(!paramMap.containsKey("id")||paramMap.get("id")==null||StringUtils.isEmpty(paramMap.get("id").toString())) {
			//新增
			paramMap.remove("id");
			paramMap.put("permissionArea", UserThreadLocal.get().get("deptId"));
	 ...
	 */
	@Override
	public boolean saveOrUpdatePropertyOpenDate(Map<String,Object> paramMap) {
		if(!paramMap.containsKey("id")||paramMap.get("id")==null||StringUtils.isEmpty(paramMap.get("id").toString())) {
			//新增
			paramMap.remove("id");
			paramMap.put("permissionArea", UserThreadLocal.get().get("deptId"));
	 ...
	 */
	@Override
	public boolean saveOrUpdatePropertyPriceTrend(Map<String,Object> paramMap) {
		if(!paramMap.containsKey("id")||paramMap.get("id")==null||StringUtils.isEmpty(paramMap.get("id").toString())) {
			//新增
			paramMap.get("id");
			paramMap.put("permissionArea", UserThreadLocal.get().get("deptId"));
	...
	@Override
	public boolean saveOrUpdateRoomTime(Map<String,Object> paramMap) {
		if(!paramMap.containsKey("id")||paramMap.get("id")==null||StringUtils.isEmpty(paramMap.get("id").toString())) {
			//新增
			paramMap.remove("id");
