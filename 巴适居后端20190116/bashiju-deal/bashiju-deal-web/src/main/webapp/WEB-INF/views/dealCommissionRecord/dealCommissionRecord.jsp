...
layui.use(['table','laydate','form'], function(){
  var table = layui.table;
    ...
    layui.laytpl={
			 //转换描述
			toPayerTypeStr : function(payerType){
			...
			toSettlementTypeStr : function(settlementType){
				  var dd = ${settlementType};
					if('${settlementType}'!='')
						return dd[settlementType]
					else
  ...
  table.render({
    ...
    ,cols: [[ //表头
      ...
      ,{field: 'payerType', title: '缴费人',templet: '<div>{{ layui.laytpl.toPayerTypeStr(d.payerType) }}</div>'}
      ,{field: 'status', title: '收取状态',templet: '<div>{{ layui.laytpl.toStatusStr(d.status) }}</div>'}
