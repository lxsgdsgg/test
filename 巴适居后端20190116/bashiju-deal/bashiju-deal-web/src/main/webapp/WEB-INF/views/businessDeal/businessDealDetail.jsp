	    ...
	    <div class="layui-tab-item layui-show">
	    	...
	    	<div class="layui-row">
	    		<div class="layui-col-xs8">
	    			<div class="border_div" style="height: 80px;">
	    				过户信息……
	    			</div>
					    ...
					    <col>
						  ...
						  <tbody>
						    <tr>
						     ...
						     <tr>
						      <td>过户</td>
						      <td>${transferStatus[deal.transferStatus]}
						      	<c:if test="${deal.transferStatus=='00'}">
						      		<button onclick="openTransferWindow()">启动过户</button>
						      	</c:if>
						      </td>
						     </tr>
						     <tr>
...
<%-- 						      	</c:if> --%>
	    ...
	    <!--过户进度-->
	    <div class="layui-tab-item" id="transferSchedule_div"></div>
	    <!--文件扫描件-->
...
// 	    alert(data.index);
		...
		if(data.index==0 || data.index==1 || data.index==3)
			return false;
		if(data.index==2){//过户进度
			ifame = "transferSchedule_div";
			url = "transferSchedulePage";
		}
