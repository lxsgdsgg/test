...
public interface DealMapper {
	 ...
	 * @return: Map<String, Object>      
	 */ 
	public Map<String,Object> queryCommissionById(@Param("id")String id);
	...
	/**     
	 * 根据过户进度编号查询成交双方的电话信息 
	 * @Description: 根据过户进度编号查询成交双方的电话信息   
	 * @param id 过户进度编号
	 * @return: Map<String,Object>      
	 */ 
	public Map<String, Object> getSchedulesMsgInfo(@Param("id")String id);
}
