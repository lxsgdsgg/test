...
public interface ContractMapper {
	 ...
	 * 
		 ...
		 * Map<String,Object>
	 */
	Map<String, Object> queryContractByCode(@Param("code")String code);
	/**
	 * 
		 * 根据合同编号查询合同图片
	 ...
	 * 
		 ...
		 * List<Map<String,Object>>
	 */
	List<Map<String, Object>> queryContractListByType(@Param("templateType")String templateType,@Param("companyId")String companyId);
	/**
	 * 
		 * 根据合同编号查询合同签订人信息
	 ...
	 * 
		 * 查询用户公司、部门
		 * @Description: 查询用户公司、部门
		 * @param id
		 * @return 
		 * Map<String,Object>
	 */
	Map<String, Object> queryUserInfo(@Param("id")Integer id);
}
