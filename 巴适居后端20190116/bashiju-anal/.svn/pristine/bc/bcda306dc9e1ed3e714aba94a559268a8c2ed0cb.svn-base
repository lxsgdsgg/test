...
<html>
		...
		<div class="layui-form-item">
		    ...
		    <div class="layui-input-inline">
		      <select name="requestType" id="requestType">
		      	<c:forEach var="requestType" items="${customerTransactionType}">
	...
	<script type="text/javascript">
		...
		layui.use(['table','laydate'], function() {
			...
			var cols = ${thead};
			table.render({
				id: 'dealConversionRateAnalysis',
				elem : '#dealConversionRateAnalysis',
				height : 'full-100',
				page : false,
				size:'sm',
				url : 'queryReportData',
				cols : cols.rows[0].cells,
				toolbar: '<div>成交转化率分析<div>', 
				totalRow:true,
		    ...
		    reload: function(){
		     ...
		     //执行重载
		      table.reload('dealConversionRateAnalysis', {
// 		        page: {
// 		          curr: 1 //重新从第 1 页开始
// 		        },
		        where: {
