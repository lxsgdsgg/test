...
/**
 * 报表资源类型 枚举类
 * @ClassName:ReportBusinessTypeEnum
...
public enum ReportBusinessTypeEnum {
	 ...
	 * @throws
	 */
	ReportBusinessTypeEnum(String code,String desc){
		this.code = code;
		this.desc = desc;
	}
	...
	static {
        ...
        for (ReportBusinessTypeEnum item : ReportBusinessTypeEnum.values()) {
        	//将枚举值放入Map对象中
     ...
     * 枚举转换
     */
    public static ReportBusinessTypeEnum parseOf(String value){
        for(ReportBusinessTypeEnum item : values())
