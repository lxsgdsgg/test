        ...
        <el-row >
          <el-col :span="12">
            <el-form-item label="签订人">
              <span>{{currRow.signPersonName}}</span>
            </el-form-item>
          </el-col>
        </el-row>
      </el-form>
