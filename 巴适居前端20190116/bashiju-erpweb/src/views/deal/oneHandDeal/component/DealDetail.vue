            ...
            <div style="background-color: #EEEEEE;line-height: 30px;">
              <span>中介类分成信息
                <el-button type="primary" @click="sureDividInfos('02','0')" size="mini" class="pull-right"
                     v-if="resultData.dealInfo.agentDividCnt === 0 && resultData.dealInfo.isBreach !== 1" :loading="confirmDivideBtn">确认分成</el-button>
                <el-button type="primary"  v-if="resultData.dealInfo.agentDividCnt === 0 && resultData.dealInfo.isBreach !== 1"
            ...
            <div style="background-color: #EEEEEE;line-height: 30px;">
              <span>金融类分成信息
                  ...
                  <el-button v-hasMultipleBtn="['updateFinDivide',resultData.dealInfo]" type='primary'
                             v-if="resultData.dealInfo.FinceDividCnt === 0 && resultData.dealInfo.isBreach !== 1"
                             @click="handlerModifyDivides('1')" size="mini" class="pull-right mr10">修改分成</el-button>
                </span>
            </div>
          </div>
