    ...
    <div class="page-content-hd">
      <el-form :model="queryForm" ref="queryForm" :inline="true" size="small" v-if="operatorTypeObj">
        ...
        <el-form-item prop="actionType" label="操作类型">
          <el-select v-model="queryForm.actionType" style="width: 120px" clearable filterable>
  ...
  export default {
    ...
    methods: {
      ...
      _getTableData() {
        ...
        RequestURL.queryHouseActionLogPageList(params).then(res => {
      ...
      returnOperatorTypeObj(){
        RequestURL.returnOperatorTypeObj({type: '1'}).then(res=>{
      ...
      returnSourceTypeObj(){
        RequestURL.returnSourceTypeObj({type: '1'}).then(res=>{
