      ...
      <div class="query-form" ref="query-form">
        <el-form size="small" :inline="true" :model="queryForm" ref="queryForm" class="demo-form-inline">
          ...
          <el-form-item prop="houseId">
            <el-input v-model.trim="queryForm.houseId" placeholder="房源编号" style="width: 150px"></el-input>
          </el-form-item>

          <el-form-item prop="rejectReason">
            <el-input v-model.trim="queryForm.rejectReason" placeholder="驳回原因" style="width: 150px"></el-input>
          </el-form-item>
          <el-form-item>
