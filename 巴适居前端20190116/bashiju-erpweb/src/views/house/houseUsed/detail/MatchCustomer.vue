  ...
  <div style="min-height: 550px">
    ...
    >
      ...
      <el-table-column
        ...
        label="区域">
        <template slot-scope="scope">
            <label v-if="scope.row.areaNames !==null && scope.row.areaNames!== ''&& scope.row.areaNames!== undefined">{{scope.row.areaNames+'-'}}</label>
            <label v-if="scope.row.regionNames !==null && scope.row.regionNames!== ''&& scope.row.regionNames!== undefined">{{scope.row.regionNames+'-'}}</label>
            <label v-if="scope.row.communityNames !==null && scope.row.communityNames!== ''&& scope.row.communityNames!== undefined" >{{scope.row.communityNames}}</label>
        </template>
      </el-table-column>
