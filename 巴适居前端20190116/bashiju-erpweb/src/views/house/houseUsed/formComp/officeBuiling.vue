  ...
  <div v-loading="loadingView" style="height: 570px">
    <el-form v-if="selectOpts" :model="detailEditForm" ref="detailEditForm" :rules="rules" label-width="110px" size="small">
      ...
      <div class="form-wrapper">
        ...
        <el-row>
          <el-col :span="6">
            <el-form-item label="实率：" prop="officeBuildRate">
              <el-input v-model="detailEditForm.officeBuildRate"><i slot="suffix" style="font-size: 12px;margin-right: 5px">%</i></el-input>
            </el-form-item>
          </el-col>

          <el-col :span="6">
            <el-form-item label="级别：" prop="officeBuildLevelId">
              <base-select
                v-model="detailEditForm.officeBuildLevelId"
                :data="selectOpts.officeBuildLevel"
                :props="selectProps"
              >
              </base-select>
            </el-form-item>
          ...
          <el-col :span="6">
            <el-form-item label="层高：" prop="floorHeight">
              <el-input v-model="detailEditForm.floorHeight"><i slot="suffix" style="font-size: 12px;margin-right: 5px">米</i></el-input>
            </el-form-item>
          </el-col>
...
<script>
  ...
  export default {
    ...
    data() {
      return {
        detailEditForm: {
          ...
          officeBuildLevelId:'',//写字楼级别
          officeBuildRate:'',//写字楼实率
          floorHeight:'',//层高
          levelType:'',//等级
          // room: '', // 室
          // hall: '', // 厅
    ...
    methods:{
      _getOptions () {
        getBaseInfoSelectOpts({param: 'officeBuiling'}).then(res => {
