    ...
    <el-form v-if="selectOpts" :model="detailEditForm" ref="detailEditForm" :rules="rules" label-width="110px" size="small">
      ...
      <div class="form-wrapper">
        ...
        <el-row>
          ...
          <el-col :span ="6">
            <el-form-item label="总楼层：" prop="totalLayers">
              <el-input v-model="detailEditForm.totalLayers"><i slot="suffix" style="font-size: 12px;margin-right: 5px">楼</i></el-input>
            </el-form-item>
          </el-col>
...
<script>
  ...
  export default {
    ...
    methods:{
      _getOptions () {
        getBaseInfoSelectOpts({param: 'factory'}).then(res => {
