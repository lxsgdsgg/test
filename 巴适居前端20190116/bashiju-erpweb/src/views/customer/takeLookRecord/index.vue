        ...
        <el-form size="small" :inline="true" :model="queryForm" ref="queryForm" class="demo-form-inline">
          ...
          <el-form-item prop="leadTime">
            <el-date-picker
              ...
              start-placeholder="带看日期起"
              end-placeholder="带看日期止"
      ...
      >
        ...
        <el-table-column
          ...
          <template slot-scope="scope">
              {{scope.row.houseType | houseTypeFilter}}
          </template>
        </el-table-column>
    ...
    components:{PageList,BaseCascader,Detail},
      ...
      name:'takeLookRecord',
        ...
        methods: {
          ...
          //带看人
          handleLeader(value,name,data){
            if(data.dataType !== 'user'){
              setTimeout(() => {
                this.queryForm.leaderId = ''
              }, 50)
              return false
            }
          }
        ...
        filters:{
          dpFilter(value){
            ...
            houseTypeFilter(value){
                if(value ===0 )return '二手房源'
                if(value ===1 )return '一手房源'
            }
        },
        mounted() {
