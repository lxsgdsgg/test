      ...
      >
        ...
        <el-table-column
          ...
          <template slot-scope="scope">
            {{scope.row.room?scope.row.room:0 + scope.row.hall + '室'}}
          </template>
    ...
    <el-tab-pane label="求购" name="buy">
      ...
      >
        ...
        <el-table-column
          ...
          <template slot-scope="scope">
            {{scope.row.minSpace?scope.row.minSpace:0 +"-" + scope.row.maxSpace + '平米'}}
          </template>
        ...
        <el-table-column
          ...
          <template slot-scope="scope">
            {{scope.row.minPrice?scope.row.minPrice:0 +"-" + scope.row.maxPrice}}
          </template>
        ...
        <el-table-column
          ...
          <template slot-scope="scope">
            {{scope.row.minRoom?scope.row.minRoom:0 + "-" + scope.row.maxRoom + '室'}}
          </template>
        ...
        <el-table-column
          ...
          <template slot-scope="scope">
            {{scope.row.minFloorCount?scope.row.minFloorCount:0 + "-" + scope.row.maxFloorCount + '楼'}}
          </template>
    ...
    <el-tab-pane label="求租" name="rent">
      ...
      >
        ...
        <el-table-column
          ...
          <template slot-scope="scope">
            {{scope.row.minPrice + scope.row.maxPrice +priceUnit}}
          </template>
        ...
        <el-table-column
          ...
          <template slot-scope="scope">
            {{scope.row.minFloorCount?scope.row.minFloorCount:0 +"0" + scope.row.maxFloorCount + '楼'}}
          </template>
