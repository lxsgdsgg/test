...
<template>
  <div>
    <div class="action-bar clearfix">
      <div class="pull-left">
        <el-button size="mini" @click="openFile">上传图片</el-button>
        <el-button @click="setCover" :type="checkedList.length ? '' : 'info'" :disabled="!checkedList.length" size="mini">设置封面</el-button>
      </div>
      <div class="pull-right">
        <el-button @click="choiceAll" size="mini">全选</el-button>
        <el-button @click="downloadImgItem" :type="checkedList.length ? '' : 'info'" :disabled="!checkedList.length" size="mini">单张下载</el-button>
        <el-button @click="downloadImages" :type="checkedList.length ? '' : 'info'" :disabled="!checkedList.length" size="mini">批量下载</el-button>
        <el-button @click="delImages" :type="checkedList.length ? '' : 'info'" :disabled="!checkedList.length" size="mini">删除</el-button>
        <el-button @click="updateType" :type="checkedList.length ? '' : 'info'" :disabled="!checkedList.length" size="mini">图片类型</el-button>
      </div>
    </div>
    ...
    >
      <el-form size="small" :model="updateTypeForm" ref="updateTypeForm" label-width="100px">
        ...
        <el-form-item
          label="原图片类型"
        >
          <el-input :value="updateTypeForm.orgPictureName"></el-input>
        </el-form-item>
