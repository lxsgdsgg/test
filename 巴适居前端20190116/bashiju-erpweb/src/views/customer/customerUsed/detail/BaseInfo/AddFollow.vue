...
<template>
  <el-form v-loading="loadingView" :model="form" :rules="rules" ref="form" label-width="100px">
    ...
    <el-form-item label="提醒人" prop="receivePeopleId" ref="receivePeopleId" :required="false">
      <base-cascader
    ...
    <el-form-item label="提醒时间" prop="remindTime" ref="remindTime" :required="false">
      <el-date-picker
    ...
    <el-form-item label="提醒内容" prop="remindContent" ref="remindContent" :required="false">
    ...
    methods: {
      ...
      switchChange(){
          if(this.form.isCancelNotice){
            ...
            this.$refs['receivePeopleId'].clearValidate()
            this.$refs['remindTime'].clearValidate()
            this.$refs['remindContent'].clearValidate()
          }
      },
      handleSubmit () {
      ...
      _getOptions () {
        getSelectValue({param: 'custFollowMethod'}).then(res => {
