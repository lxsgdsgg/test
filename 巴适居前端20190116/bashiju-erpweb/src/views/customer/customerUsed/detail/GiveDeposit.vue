  ...
  <div>
    ...
    <template>
        ...
        <el-dialog
          ...
          append-to-body
        >
        <select-er-house @handleClickRow="handleErClickRow" :transactionTypeId="topParams.transactionTypeId" :regionValue="regionValue" :deptSelectOpts="peopleSelectOpts" ref="selectErHouseDialog"> </select-er-house>
        </el-dialog>
           ...
           this.$refs['formDeposit'].validate((valid) => {
             if (valid) {
                ...
                saveDeposit(params, cfg).then(res => {
                  ...
                  //记日志
                  let logContent = "下定客户:"+this.topParams.custName+";下定金额(元)："+this.formDeposit.price+";下定日期:"+this.formDeposit.entrustTime+";经办人:"+this.formDeposit.trustees+";预计成交金额（万元):"+this.formDeposit.maybeDealPrice+";预计成交日期:"+this.formDeposit.maybeDealDate
                  let message = {
                      ...
                      operatTypeId: 210,
                      newHouseId: this.shhId,
                      newHouseCode: this.houseId,
