          ...
          <div class="center">
            <div class="status-wrap">
              <el-form-item label="状态">
                ...
                <div class="item" v-if="this.$route.params.type == 4">
                  <a
                    @click="setQueryStatus({'effective': 4}), statusItemActive = '我购', statusItemChildActive = ''"
                    :class="{active: statusItemActive === '我购'}"
                    class="grey-color" href="javascript:;">我购
                  </a>
                </div>
                <div class="item" v-else-if="this.$route.params.type == 5">
                  <a
                    @click="setQueryStatus({'effective': 5}), statusItemActive = '我租', statusItemChildActive = ''"
                    :class="{active: statusItemActive === '我租'}"
                    class="grey-color" href="javascript:;">我租
                  </a>
                </div>
                <div class="item">
                  <a
                  ...
                  <transition name="el-zoom-in-center">
                    <div class="children" v-show="statusItemActive === '失效'">
                      ...
                      <div class="content">
                          <a
                            @click="setQueryStatus({'effective': 7}), statusItemChildActive = '他购'"
                            :class="{active: statusItemChildActive === '他购'}"
                            class="child" href="javascript:;">他购
                          </a>
                          <a
                            @click="setQueryStatus({'effective': 8}), statusItemChildActive = '暂缓'"
                            :class="{active: statusItemChildActive === '暂缓'}"
                            class="child" href="javascript:;">暂缓
                          </a>
                          <a
                            @click="setQueryStatus({'effective': 9}), statusItemChildActive = '撤单'"
                            :class="{active: statusItemChildActive === '撤单'}"
                            class="child" href="javascript:;">撤单
                          </a>
                          <a
                            @click="setQueryStatus({'effective': 10}), statusItemChildActive = '他租'"
                            :class="{active: statusItemChildActive === '他租'}"
                            class="child" href="javascript:;">他租
                          </a>
                      </div>
                    </div>
                  </transition>
  ...
  export default {
    ...
    // 选择搜索区域状态项 失效复选框
      ...
      _formatQueryParams (form) {
        ...
        this.queryParams.matchingIds && (temp.matchingIds = form.matchingIds.join(','))//数组拆分
        ...
        if(temp.matchingIds){
          temp.matchingIds = temp.matchingIds.join(',')
        }
