      ...
      <div class="form-wrapper">
        <el-row>
          ...
          <el-col :span="6">
            ...
            <el-form-item prop="selectAreaId" label="需求区划">
              <community-selector
                style="width: 180px"
                v-model="detailEditForm.selectAreaId"
                :url="areasUrl"
                :props="cascaderProps"
        ...
        <el-row>
          ...
          <el-col :span="6">
            <el-form-item label="需求价格:" prop="price">
                <base-section-select v-model="detailEditForm.price" :data="regionValue.price"   placeholder="需求价格" :description="priceUnit" ></base-section-select>
            </el-form-item>
          </el-col>
    ...
    <el-row>
          ...
          <el-col :span="6">
            <el-form-item label="联系地址" prop="contactAddress">
              ...
              <el-input type="text" v-model="detailEditForm.contactAddress" style="width: 100%"></el-input>
      ...
      <div class="btn-group">
        <el-button v-if="isAdd || formInfo.firstInfo" type="primary" @click="handleLastStep" size="medium">上一步</el-button>
