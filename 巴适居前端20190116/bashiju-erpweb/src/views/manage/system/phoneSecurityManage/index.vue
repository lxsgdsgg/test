  ...
  <div class="page-content">
    <div class="page-content-hd">
        <el-form size="small" :inline="true" :model="form" ref="form">
          ...
          <el-form-item class="margin-b-none"  prop="companyId">
            <base-cascader change-on-select
             clearable v-model="form.companyId"
             :change-on-select="false"
             @change="handleCiytAndCompany"
             placeholder="选择公司"
             :data="cityAndCompany"
             :props="cascaderProps"
          ...
          <el-form-item>
            ...
            <el-button v-hasOnlyBtn="'bindBtn'" @click.native.prevent="handleAddDiolorg">绑定</el-button>
          </el-form-item>
        </el-form>
      </div>
