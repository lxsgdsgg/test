    ...
    <div class="page-content-hd">
      <div class="query-form" ref="query-form">
        <el-form size="small" :inline="true" :model="queryForm" class="demo-form-inline" ref="queryForm">
          ...
          <!--<el-form-item>-->
            <!--<el-button v-hasOnlyBtn="'deptTypeAdd'" type="primary" @click="handleAdd" :isAdd="isAdd">新增</el-button>-->
          <!--</el-form-item>-->
        </el-form>
      </div>
    </div>
      ...
      >
        ...
        <!--&gt;-->
          <!--<template slot-scope="scope">-->
            <!--<el-button v-hasOnlyBtn="'deptTypeEdit'" @click="handleEdit(scope.row)" type="text" size="small" :loading="loadingBtn">编辑</el-button>-->
            <!--<el-button v-hasOnlyBtn="'deptTypeDel'" @click="handleDelete(scope.row)" type="text" size="small">删除</el-button>-->
          <!--</template>-->
        <!--</el-table-column>-->
      </el-table>
      <!--分页控件-->
...
export default {
  ...
  methods: {
    ...
    handlerQuery(isLoading){
      ...
      this.queryDeptTypePageList(isLoading)
    },
