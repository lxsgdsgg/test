        ...
        this.$refs['form'].validate((valid) =>{
          if(valid){
            ...
            this.$confirm('确定保存编辑的信息吗?',{
              ...
              params.minWages = params.wages.min*100
              params.maxWages = params.wages.max*100
                ...
                if(res.success){
                  ...
                  if(this.isAdd){
                    let message = {
                      ...
                      sourceTypeId:13,// 13：人力
                      businessTypeId: 6,//业务类型：办公平台，
                      operatTypeId: 616,//操作类型: 616//新增招聘信息
                      logContent:'新增招聘信息:'+ params.name
                    }
                    RequestLogUrl.oaAddLog({message:JSON.stringify(message)}).then(res=>{
                      ...
                      let message = {
                        ...
                        sourceTypeId:13,// 13：人力
                        businessTypeId: 6,//业务类型：办公平台，
                        operatTypeId: 617,//操作类型: 617//修改招聘信息
