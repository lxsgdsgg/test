        ...
        >
          ...
          >
            <template slot-scope="scope">
              <el-button  v-hasMultipleBtn="['taskDistrubuteBtn',scope.row]"  @click="handleDistribution(scope.row)" type="text" size="small">任务分配</el-button>
              <el-button  v-hasMultipleBtn="['taskDetailBtn',scope.row]" @click="handleDetail(scope.row)" type="text" size="small">任务详情</el-button>
              <el-button  v-hasMultipleBtn="['updTaskBtn',scope.row]" @click="handleEditor(scope.row)" type="text" size="small"  icon="el-icon-edit" ></el-button>
              <el-button v-hasMultipleBtn="['delTaskBtn',scope.row]"  @click="handleDelete(scope.row)" type="text" size="small" icon="el-icon-delete"></el-button>
            </template>
          </el-table-column>
