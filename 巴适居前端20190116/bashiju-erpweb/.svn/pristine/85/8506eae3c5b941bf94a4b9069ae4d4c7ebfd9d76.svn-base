<template>
  <div class="wscn-http404-container">
    <div class="wscn-http404">
      <div class="pic-404">
        <img class="pic-404__parent" :src="errGif" alt="404">
      ...
      <div class="bullshit">
        ...
        <div class="bullshit__info">您的网页丢失，请点击以下按钮返回主页或者联系系统管理员！</div>
...
<script>
import errGif from '../../common/images/404.png'
import errCloud from '../../common/images/404_cloud.png'
