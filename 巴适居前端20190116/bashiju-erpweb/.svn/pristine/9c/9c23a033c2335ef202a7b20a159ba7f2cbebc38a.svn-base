      ...
      <div>
        <el-form size="small" :inline="true" :model="form" ref="form"  class="demo-form-inline">
          ...
          <el-form-item  prop="dealType"  >
            <el-select v-model="form.dealType" style="width: 120px" placeholder="类型">
              <el-option
          ...
          <el-form-item prop="dividerId">
              <base-cascader
                placeholder="分成人" clearable v-model="form.dividerId" :url="getReferenceUserSelectUrl"
          ...
          <el-form-item  prop="isValid">
            <el-select v-model="form.isValid" style="width: 100px" placeholder="状态">
                <el-option
