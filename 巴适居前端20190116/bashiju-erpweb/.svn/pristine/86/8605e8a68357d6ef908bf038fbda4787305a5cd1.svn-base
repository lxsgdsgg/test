...
<template>
  <div :id="dropWrapId">
    ...
    <transition name="el-zoom-in-top">
      ...
      <div v-show="isFocus" class="dropdown el-select-dropdown el-popper" x-placement="bottom-start" style="width: 255%; left: -80%">
        ...
        <div class="popper__arrow" style="left: 50%;"></div>
      </div>
