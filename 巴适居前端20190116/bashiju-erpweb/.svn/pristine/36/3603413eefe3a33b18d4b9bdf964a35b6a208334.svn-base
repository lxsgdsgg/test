<template>
  ...
  <div>
    <el-form ref="form" :model="form" :rules="rules" label-width="80px">
      <el-form-item label="行政区划" prop="temp">
        <base-cascader
      ...
      props:{
        ...
        methods: {
          setForm(data){
              ...
              if(data.areaCode !=='' && data.cityCode !==''&& data.regionId!==''){
                this.form.regionId = String(data.regionId);
                this.form.temp = this.form.regionId
              }
              if (data.regionId ===''){
                this.form.areaCode = data.areaCode;
                this.form.temp = this.form.areaCode
              }
              if(data.areaCode ==='' && data.regionId ===''){
                this.form.cityCode = data.cityCode;
                this.form.temp = this.form.cityCode
              }
          ...
          queryAllRegionListByAreaCode(value,name,data){
            ...
            if(data.dataType === 'city'){
              ...
              this.form.cityCode = data.parent.parentCode
            }
          },
          handleSubmit(){
