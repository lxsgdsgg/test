  ...
  >
            ...
            <div class="left">
              ...
              <div class="phoneList" v-show="showPhoneList">
                ...
                <div class="phoneList-item" v-for="(item,index) in phoneList" :key="item.id">
                  ...
                  <el-button v-if="item.ismainFlag!=1" @click="handleDeleteOwnerPhone(index,item.id,item.phone)" type="text" size="mini">删除</el-button>
                </div>
    ...
    <template>
      ...
      <el-dialog
        ...
        :close-on-click-modal="false"
      >
        <get-archives @closeModel="closeArchivesModel" :demandId="demandId"></get-archives>
      </el-dialog>
...
<script>
  ...
  export default {
    ...
    methods: {
      closeArchivesModel () {
        this.dialogVisibleArchives = false
      },
      //客户档案
        ...
        let params = {
          ...
          RequestURL.getCustomerPhone(params).then(res => {
            if(res.data[0].examineNum>0){
               ...
               console.log(this.resultData.customerInfo.transactionTypeId)
                //记日志
              let phones = ''
