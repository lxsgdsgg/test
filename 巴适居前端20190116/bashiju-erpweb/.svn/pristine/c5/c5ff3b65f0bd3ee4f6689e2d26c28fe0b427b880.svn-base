  ...
  <div class="page-content">
    <div class="query-form">
      <el-form size="mini" ref="queryForm" :inline="true" :model="queryForm" class="demo-form-inline">
        ...
        <el-form-item>
          ...
          <el-button type="primary" @click="handleAddType">新增区间</el-button>
        </el-form-item>
      </el-form>
    </div>
    <el-row :gutter="20">
    ...
    <template>
      <el-dialog
        ...
        <el-form v-loading="loadingEditView"
                 :model="addForm" status-icon
                 :rules="addFormRules"
                 ref="addForm"
                 label-width="100px"
        >
          ...
          <el-row>
            <el-col :span="24">
              <div class="save-btn">
                <el-button type="primary" @click="saveRange" :loading="loadingSaveBtn" size="small">确定</el-button>
      ...
      <el-dialog
        :visible.sync="dialogAddRangeType"
        title="新增区间"
        width="400px"
        append-to-body
        :modal-append-to-body="false"
      >
        <el-form size="small" ref="form" :inline="true" :model="form" :rules="formRules" class="demo-form-inline" label-width="100px">
          ...
          <el-form-item label="控件名称" prop="name">
            <el-input v-model="form.name" placeholder="请输入控件名称"></el-input>
          </el-form-item>

          <el-form-item label="控件编号" prop="widgetCode">
            <el-input v-model="form.widgetCode" @blur="validateWidgetCode" placeholder="请输入控件编号"></el-input>
          </el-form-item>

          <div class="btn-group">
            <el-button type="primary"  @click="saveRangeType" :loading="loadingSaveTypeBtn" size="small">确定</el-button>
            <el-button   @click="dialogAddRangeType=false" size="small">取消</el-button>
          </div>
  ...
  export default {
    ...
    methods: {
      ...
      _loadData (btnQuery) {
        ...
        this.nowQueryForm.cityCode = this.data.cityCode
