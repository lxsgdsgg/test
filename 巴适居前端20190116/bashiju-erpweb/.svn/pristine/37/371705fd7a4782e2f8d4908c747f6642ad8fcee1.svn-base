  ...
  >
        ...
        <el-card class="box-card info">
          ...
          <div class="header-info clearfix">
            ...
            <div class="left pull-left">
              ...
              <div class="detail">
                <div class="item">需求区域：<span>{{resultData.customerInfo.communityNames}}</span></div>
            ...
            <div class="right pull-right">
              <div class="tool mr10">
                <div class="mb10">
                  <a href="javascript:;" class="text-btn">地图坐标</a>
                </div>
              </div>
        ...
        <el-card class="owner-info">
          ...
          <div class="item clearfix">
            <div class="left"><span class="text-grey mr5">客户：</span>
              {{resultData.customerInfo.custName + resultData.customerInfo.relateTypeName}}
              <!-- <el-button @click="handleEditOwnerInfo" size="mini" type="text"><i class="el-icon-edit ml10"></i>修改信息</el-button> -->
            </div>
            <div class="right"><el-button @click="dialogVisibleArchives = true" size="mini" type="text"><i class="el-icon-tickets ml5"></i>客户档案</el-button></div>
          ...
          <div class="item">
            <div class="left">
              ...
              <div class="phoneList" v-show="showPhoneList">
                ...
                <div class="phoneList-item" v-for="item in phoneList" :key="item.id">
                  ...
                  <el-button @click="handleDeleteOwnerPhone(item.id)" type="text" size="mini">删除</el-button>
                </div>
            ...
            <div class="right">
              <el-button @click="dialogVisibleHousePath = true" size="mini" type="text"><i class="el-icon-tickets ml5"></i>看房轨迹</el-button>
            </div>
          </div>

          <div style="margin-left: 35px" class="add-phone">
              <el-button @click="handleEditOwnerPhone(null)" size="mini" type="text"><i class="el-icon-circle-plus ml5"></i>新增电话</el-button>
              <el-button v-show="!showPhoneList" @click="handleShowPhoneList" type="primary" size="small" icon="el-icon-mobile-phone" style="display: block">查看电话</el-button>
          </div>
          ...
          <template v-for="(value, key) in RELATEAGENT_FIELD">
            ...
            <div class="agent-item" :key="key">
              ...
              <div class="content">
                ...
                <template>
                  <el-button @click="handleEditAgentInfo(key)" v-if="key === '5'" class="btn pull-right" type="primary" plain size="mini">变更维护人</el-button>
                </template>
    ...
    <template>
      ...
      <el-dialog
        ...
        :close-on-click-modal="false"
      >
        <look-house-path></look-house-path>
      </el-dialog>
      ...
      <el-dialog
        ...
        :close-on-click-modal="false"
      >
        <edit-agent-info v-if="hackResetAgent" :peopleSelectOpts="peopleSelectOpts" @handleBtnClick="handleAgentBtnClick" :type="dialogAgentType" :data="agentFormData" ref="editAgent"></edit-agent-info>
      </el-dialog>
...
<script>
  ...
  export default {
    ...
    mounted () {
      //this.demandId = 'KY-180824003'
      this.demandId = this.params.demandId
      this._loadData()
    },
