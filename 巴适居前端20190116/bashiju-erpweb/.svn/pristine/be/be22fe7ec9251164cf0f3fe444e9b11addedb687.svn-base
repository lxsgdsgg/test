    ...
    <div class="page-content-hd">
        <el-form size="small" :inline="true" :model="queryForm" ref="queryForm" class="demo-form-inline">
          <el-form-item  prop="transactionType">
            <el-select v-model="queryForm.transactionType" placeholder="客源交易类型" style="width: 130px">
            ...
            <el-form-item  prop="levelType">
              <el-select v-model="queryForm.levelType" placeholder="房屋等级" style="width: 130px">
          ...
          <el-form-item class="margin-b-none"  prop="cityOrCompany">
            <base-cascader change-on-select    clearable v-model="cityOrCompany" @change="handleCiytAndCompany" placeholder="选择城市"  :data="cityAndCompany" :props="cascaderProps" :dataProps="cascaderDataProps" style="width: 140px" ></base-cascader>
          </el-form-item>
...
<script>
  ...
  import BaseCascader from '@/components/BaseCascader'
    export default {
      ...
      mixins:[PageList],
      components:{BaseCityCascader,PageList,CustLevelConditionEditor,BaseCascader},
        data() {
            return {
              queryForm:{
                transactionType:'',
