<template>
  <div class="page-content">
    <div class="page-content-hd">
        <el-form size="small" :inline="true" :model="queryForm" ref="queryForm" class="demo-form-inline">
          <el-form-item  prop="transactionType">
            <el-select v-model="queryForm.transactionType" placeholder="房源交易类型" style="width: 140px">
            ...
            <el-form-item  prop="levelType">
              <el-select v-model="queryForm.levelType" placeholder="房屋等级" style="width: 140px">
                <el-option label="A等级" value="A"></el-option>
                <el-option label="B等级" value="B"></el-option>
              </el-select>
            </el-form-item>

          <el-form-item class="margin-b-none"  prop="cityOrCompany">
            <base-cascader change-on-select     clearable v-model="cityOrCompany" @change="handleCiytAndCompany" placeholder="选择城市或公司"  :data="cityAndCompany" :props="cascaderProps" :dataProps="cascaderDataProps" style="width: 140px" ></base-cascader>
          </el-form-item>
    ...
    <div class="page-content-bd" v-loading="loadingView">
      ...
      <div class="bor">
        <br>
          <div style="margin-center: 25px;color: gray">
            A、B级:有效且符合设置条件
            <br/>
            <br/>
            C级:有效且非A、B级
      ...
      components:{CitySelector,PageList,HouseLevelConditioinEditor,BaseCascader},
        data() {
            return {
              ...
              // queryOpenCityCountyUrl: selectUrl.queryOpenCityCompany, // 区县
        ...
        methods: {
          ...
          handleAdd(value){
            ...
            this.$nextTick(() =>{
              ...
              this.dynamicTitle = '新增'+this.type+'房源等级条件'
              if(value == 1){
         ...
         //格式化时间
          ...
          handleCiytAndCompany(value,name,data){
            console.log(name)
            this.queryForm.companyId = '';
            this.queryForm.cityCode = '';
            if(data.dataType === 'company'){
                this.queryForm.companyId = data.code
            }else if(data.dataType === 'city'){
              this.queryForm.cityCode = data.code
            }
          }
        },
        filters:{
