<template>
  <div>
    <div class="wrapper">
      <div class="toolbar">
        <div @click="handleEditBaseInfo" class="toolbar-item">
          <div class="icon">
        ...
        <div class="toolbar-group-btn">
          <p @click="dialogVisibleUpdateStatus = true">
          ...
          <template>
            <p v-if="customerInfo && customerInfo.taobaoStatusId === 0" @click="toTaoBao">
              <icon name="houseDetail_tao" width="18" height="18"></icon>
              <span>进入淘宝</span>
            </p>

            <p v-if="customerInfo && customerInfo.taobaoStatusId === 1" @click="dialogVisibleUpdateTaoBao = true">
              <icon name="houseDetail_tao" width="18" height="18"></icon>
              <span>淘宝</span>
            </p>
          </template>
        ...
        <div @click="setPrivateDisc" class="toolbar-item">
          <div class="icon">
        ...
        <div @click="setPublicDisc" class="toolbar-item">
          <div class="icon">
        ...
        <div @click="dialogVisibleAddFollow = true" class="toolbar-item">
          <div class="icon">
        ...
        <div @click="dialogVisibleUpdateRemind = true" class="toolbar-item">
          <div class="icon">
        ...
        <div @click="dialogVisibleWriteLookHouse = true" class="toolbar-item">
          <div class="icon">
        ...
        <div @click="dialogVisibleDeposit = true" class="toolbar-item">
          <div class="icon">
        ...
        <div @click="dialogVisibleUpdateHouseClose = true" class="toolbar-item">
          <div class="icon">
        ...
        <div @click="handleChangeHouse" class="toolbar-item">
          <div class="icon">
            <icon name="houseDetail_convert" width="35" height="35"></icon>
          </div>
          <p>租售转换</p>
        </div>
        <div @click="dialogVisibleUpdateUsage = true" class="toolbar-item">
          <div class="icon">
      ...
      <el-tabs v-model="activeName" @tab-click="handleTabClick" type="card" style="max-width: 1280px">
        ...
        <el-tab-pane label="基本信息" name="houseInfo">
          <base-info @loadDataFinish="_getHouseInfo" :params="{formName: $route.query.formName, demandId: $route.query.demandId}" @switchTab="switchTab" ref="baseInfo" :peopleSelectOpts="peopleSelectOpts"></base-info>
        </el-tab-pane>
        ...
        <el-tab-pane label="跟进记录" name="followRecord">
          <follow-record ref="followRecord"></follow-record>
        </el-tab-pane>

        <el-tab-pane label="带看记录" name="lookRecord">
          <look-record ref="lookRecord"></look-record>
        </el-tab-pane>
      ...
      <template>
        ...
        >
          ...
          <el-form ref="formUpdateStatus" :model="formUpdateStatus" :rules="rulesUpdateStatus" size="medium" label-width="80px">
            ...
            <el-form-item label="现状态" prop="form2">
        ...
        >
          ...
          <el-form ref="formUpdateHouseClose" :model="formUpdateHouseClose" :rules="rulesUpdateHouseClose" size="medium" label-width="80px">
            ...
            <el-form-item class="margin-b-none">
              ...
              <el-button @click="dialogVisibleUpdateBusinessExamine = false">取消</el-button>
            </el-form-item>
          </el-form>
        ...
        >
          ...
          <add-follow @submit="handleFollowSubmit" :peopleSelectOpts="peopleSelectOpts" ref="follow"></add-follow>
        ...
        >
          ...
          <write-look-house @submit="handleLookHouseSubmit" :topParams="topParams"  :regionValue="regionValue" :deptSelectOpts="deptSelectOpts" ref="writelook"></write-look-house>
        </el-dialog>
...
<script>
  ...
  import {changeSomeStatus, businessExamine, updateTag, changeHouseOwner, saveCustomerFollowAndRemind} from '@/request/customer/customerUsed'
  ...
  export default {
    name: 'customerUsedDetail',
    components: {BaseInfo, MatchCustomer, HouseDescription, LookRecord, FollowRecord, AgentFeedback, ChangeHistory, EditBaseInfo, AddFollow, DealFormComp, BaseCascader, FeedbackFormComp, PhotoComp02, PhotoComp01,WriteLookHouse,GiveDeposit,ChangeHouse},
    data () {
      return {
    ...
    setPublicDisc(){
      this.$confirm('您确定要把此客源放入公客么？', {
          ...
          changeSomeStatus(params, this.requestCfg).then(res => {
            this._msg('success', res.msg)
            this.houseInfo.discStatusId = 2
            this.houseInfo.discStatus = '公盘'
          })
        })
    },
      // 跟进组件提交完成
      ...
      _goPage (action) {
        ...
        this.$router.push({ path: './customerDetail', query: { demandId: customerList[goIndex].demandId, formName: 'house_customer'}})
      },
