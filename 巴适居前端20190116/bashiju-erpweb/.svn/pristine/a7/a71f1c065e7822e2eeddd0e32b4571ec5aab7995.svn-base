    ...
    <el-form v-if="selectOpts" :model="detailEditForm" ref="detailEditForm" :rules="rules" label-width="110px" size="small">
      ...
      <div class="form-wrapper">
        ...
        <el-row>
          ...
          <!--<el-col :span="5">-->
            <!--<el-form-item label="土地规划" prop="floorHeight">-->
              <!--<base-select-->
                <!--v-model="detailEditForm.industryId"-->
                <!--:data="selectOpts.industryId"-->
                <!--:props="selectProps"-->
              <!--&gt;-->
              <!--</base-select>-->
            <!--</el-form-item>-->
          ...
          <el-col :span="7">
            <el-form-item label="土地状况" prop="situationId">
              <base-select
                v-model="detailEditForm.situationId"
                :data="selectOpts.situationId"
                :props="selectProps"
              >
              </base-select>
            </el-form-item>
        ...
        <el-row>
          ...
          <el-col :span ="6">
            <el-form-item label="面积：" prop="buildSpace">
              <el-input v-model="detailEditForm.buildSpace" style="width: 80%"><i slot="suffix" style="font-size: 12px;margin-right: 5px">平米</i></el-input>
            </el-form-item>
          </el-col>
