<template>
  <div class="wrapper" v-loading="loadingView">
    <div v-if="Object.keys(houseInfo).length" class="toolbar">
      ...
      <div v-hasMultipleBtn="[PERMISSION_BTN.ACCUSATION, houseInfoPermission]" @click="handleTipOff" class="toolbar-item">
        <div class="icon">
    ...
    <el-tabs v-model="activeName" @tab-click="handleTabClick" type="card" style="max-width: 1280px;">
      ...
      <el-tab-pane label="日志" name="logs">
        <house-log :houseCode="houseInfo.houseCode" ref="logs"></house-log>
      </el-tab-pane>

      <el-tab-pane label="房屋描述" name="houseDescription">
        <house-description :logMessage="logMessage" :houseId="houseId" ref="houseDescription" ></house-description>
      </el-tab-pane>
    ...
    <template>
        ...
        <el-form ref="formUpdateStatus" :model="formUpdateStatus" :rules="rulesUpdateStatus" size="medium" label-width="80px">
          ...
          <el-form-item label="现状态" prop="statusId">
            <el-select v-model="formUpdateStatus.statusId" placeholder="请选择状态" style="width: 100%;">
              <el-option v-for="item in statusOpts" v-if="item.label !== '有效'" :label="item.label" :value="item.value" :key="item.value"></el-option>
            </el-select>
          </el-form-item>
      ...
      >
        ...
        <el-form ref="formUpdateTipOff" :model="formUpdateTipOff" :rules="rulesUpdateTipOff" size="medium" label-width="80px">
          <el-form-item label="举报类型" prop="accusationTypeId">
      ...
      >
        ...
        <div>
          <ContractContent v-if="hackResetContract" @canelContract="cancelContract" @saveResult="contractSaveResult" @nextOperation="contractNextOperation"
              :companyId="this.houseInfo.companyId"   :deptId="this.houseInfo.mainterDeptId" :deptName="this.houseInfo.mainterDept" :maintainId="this.houseInfo.maintainId" :maintainer="this.houseInfo.maintainer"            :houseCompanyName="this.houseInfo.companyName"
  ...
  export default {
    ...
    methods: {
        ...
        this.$refs['formHouseOpen'].validate((valid) => {
          if (valid) {
            this.$confirm('确定保存编辑的信息吗？', {
              ...
              let transactionTypeId = this.formHouseOpen.transactionTypeId
              let rentPriceName = ''
              if (transactionTypeId === '2' || transactionTypeId === '3') {
                rentPriceName = this.rentPriceOpts.find(item => item.value === transactionTypeId).label
              }
              ...
              let examineInfo = {
                ...
                remark: Object.assign({}, this.formHouseOpen, {
                  ...
                  rentPriceTypeName: rentPriceName,
      ...
      addFeedback () {
        ...
        this.feedbackParams = {
          shhId: this.houseId,
          sourceId: this.houseInfo.shhId,
          sourceCode: this.houseInfo.houseId,
          sourceTypeId: this.houseInfo.transactionTypeId,
      ...
      handleTipOff () {
        this.$refs['formUpdateTipOff'] && this.$refs['formUpdateTipOff'].resetFields()
        this.dialogVisibleUpdateTipOff = true
      },
